...
export default function SettingsPage() {
  ...
  return (
    <div className="px-5 py-6 lg:px-8 lg:py-8 h-full flex flex-col">
      <PageHeader
        eyebrow="Administration"
        title="Settings"
        subtitle="The CRM control center for company setup, users, access, security, modules, workflow automation, integrations, data administration, and notifications."
      />

      <div className="flex flex-1 mt-6 min-h-0 overflow-hidden rounded-xl border border-theme bg-white shadow-sm">
          ...
          <div className="p-4 border-b border-white/10">
            ...
            <label className="mt-4 flex items-center gap-2 rounded-lg border border-white/15 bg-white px-3 py-2 shadow-sm">
              ...
              <input
                ...
                className="w-full bg-transparent text-[13px] text-theme-primary outline-none placeholder:text-theme-muted"
              />
            </label>
          </div>
