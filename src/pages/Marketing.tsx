  ...
  return (
    <div className="marketing-container">
      <PageHeader
        ...
        subtitle={`Live view of platforms, creatives, campaigns and performance â€” tuned for ${industry.tagline.toLowerCase()}.`}
        actions={
                ...
                <div className="marketing-creative-body">
                  <div className="marketing-creative-header">
                    <div>
                      ...
                      <div className="marketing-creative-meta">{c.platform} Â· {c.id}</div>
                    </div>
                  </div>
                ...
                return (
                  <tr key={c.id}>
                    ...
                    <td className="marketing-window-cell">
                      {c.startDate} <span className="marketing-window-arrow">â†’</span> {c.endDate}
                    </td>
                  </tr>
                )
              })}
