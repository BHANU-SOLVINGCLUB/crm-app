...
export default function LeadDetailPage() {
  ...
  // which makes Object.is always return false â†’ infinite re-render loop.
        ...
        <Card className="crm-glass-header overflow-visible">
          <CardContent className="grid gap-6 p-6 lg:p-8 lg:grid-cols-[minmax(0,1.6fr)_minmax(320px,0.8fr)]">
            ...
            <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
              ...
              <MetricCard label="Last Activity" value={`${formatDateLabel(lastActivity)} â€¢ ${formatTimeLabel(lastActivity)}`} />
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div className="min-w-0 flex-1">
                                ...
                                <div className="mt-2 text-xs uppercase tracking-[0.16em] text-slate-400">
                                  {formatDateLabel(document.uploadedAt)} â€¢ {document.uploadedBy}
                                </div>
                              </div>
                            </div>
                            <div className="flex flex-wrap gap-2">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="space-y-2">
          ...
          <div className="text-xs uppercase tracking-[0.18em] text-slate-400">
            {formatDateLabel(item.scheduledAt)} â€¢ {formatTimeLabel(item.scheduledAt)}
          </div>
        </div>
