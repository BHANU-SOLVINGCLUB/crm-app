    ...
    <div className="card p-5">
      <div className="flex items-start justify-between">
        <div className="min-w-0 flex-1">
          <div className="text-[12px] uppercase tracking-widest text-slate-400 font-semibold whitespace-nowrap">{label}</div>
          <div className="mt-2.5 text-[24px] font-bold tracking-tight leading-none whitespace-nowrap">{value}</div>
        </div>
        {Icon && (
